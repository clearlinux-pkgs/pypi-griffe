...
Source0  : https://files.pythonhosted.org/packages/ed/9b/b9396f07474c9d14095b01308a5751e3afb7ef1fc3493c63ffae8d209a5d/griffe-0.36.7.tar.gz
...
%prep
%setup -q -n griffe-0.36.7
cd %{_builddir}/griffe-0.36.7
pushd ..
cp -a griffe-0.36.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697557345
