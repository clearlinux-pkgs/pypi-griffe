...
Version  : 0.40.0
Release  : 36
URL      : https://files.pythonhosted.org/packages/89/1d/275ab41f892cc83492de683681e8f8a71ce955be6046446e44226cb74f53/griffe-0.40.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/89/1d/275ab41f892cc83492de683681e8f8a71ce955be6046446e44226cb74f53/griffe-0.40.0.tar.gz
...
%prep
%setup -q -n griffe-0.40.0
cd %{_builddir}/griffe-0.40.0
pushd ..
cp -a griffe-0.40.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706719142
