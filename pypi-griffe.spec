...
Version  : 0.39.1
Release  : 35
URL      : https://files.pythonhosted.org/packages/a7/85/3fab78fb9d62b20f4da9f28d6633c3c556df4b6410cc3038b25b7bcc5121/griffe-0.39.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/a7/85/3fab78fb9d62b20f4da9f28d6633c3c556df4b6410cc3038b25b7bcc5121/griffe-0.39.1.tar.gz
...
%prep
%setup -q -n griffe-0.39.1
cd %{_builddir}/griffe-0.39.1
pushd ..
cp -a griffe-0.39.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705702110
