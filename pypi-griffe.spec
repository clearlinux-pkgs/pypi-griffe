...
Source0  : https://files.pythonhosted.org/packages/a9/3e/5aa9a61f7c3c47b0b52a1d930302992229d191bf4bc76447b324b731510a/griffe-1.7.3.tar.gz
...
%prep
%setup -q -n griffe-1.7.3
cd %{_builddir}/griffe-1.7.3
pushd ..
cp -a griffe-1.7.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745417353
