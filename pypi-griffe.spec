...
Version  : 1.6.1
Release  : 74
URL      : https://files.pythonhosted.org/packages/6a/ba/1ebe51a22c491a3fc94b44ef9c46a5b5472540e24a5c3f251cebbab7214b/griffe-1.6.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/6a/ba/1ebe51a22c491a3fc94b44ef9c46a5b5472540e24a5c3f251cebbab7214b/griffe-1.6.1.tar.gz
...
%prep
%setup -q -n griffe-1.6.1
cd %{_builddir}/griffe-1.6.1
pushd ..
cp -a griffe-1.6.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742432501
