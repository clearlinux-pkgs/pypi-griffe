...
Source0  : https://files.pythonhosted.org/packages/d4/c9/8167810358ca129839156dc002526e7398b5fad4a9d7b6e88b875e802d0d/griffe-1.5.1.tar.gz
...
%prep
%setup -q -n griffe-1.5.1
cd %{_builddir}/griffe-1.5.1
pushd ..
cp -a griffe-1.5.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729260692
