...
Source0  : https://files.pythonhosted.org/packages/88/f0/a001e06c321dfa220103418259afbac50b933eac7a86657a4b572f0517e8/griffe-1.5.6.tar.gz
...
%prep
%setup -q -n griffe-1.5.6
cd %{_builddir}/griffe-1.5.6
pushd ..
cp -a griffe-1.5.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738266983
