...
Version  : 0.39.0
Release  : 34
URL      : https://files.pythonhosted.org/packages/d0/f9/a1b41fb911d050355713b5518f37c19b2b11a295550ae50c89124beaf0a2/griffe-0.39.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/d0/f9/a1b41fb911d050355713b5518f37c19b2b11a295550ae50c89124beaf0a2/griffe-0.39.0.tar.gz
...
%prep
%setup -q -n griffe-0.39.0
cd %{_builddir}/griffe-0.39.0
pushd ..
cp -a griffe-0.39.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705502107
