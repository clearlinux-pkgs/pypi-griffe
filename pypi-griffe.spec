...
Version  : 0.25.5
Release  : 2
URL      : https://files.pythonhosted.org/packages/4d/ad/31b565138799489114cb9459175dff2a8b478f37a2a88ed855682701d519/griffe-0.25.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/4d/ad/31b565138799489114cb9459175dff2a8b478f37a2a88ed855682701d519/griffe-0.25.5.tar.gz
...
%prep
%setup -q -n griffe-0.25.5
cd %{_builddir}/griffe-0.25.5
pushd ..
cp -a griffe-0.25.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676653941
