...
Version  : 0.42.2
Release  : 44
URL      : https://files.pythonhosted.org/packages/bd/7a/6b672791342935f8500c1928ac1f12c0c4567ce182556a57533908b76ac7/griffe-0.42.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/bd/7a/6b672791342935f8500c1928ac1f12c0c4567ce182556a57533908b76ac7/griffe-0.42.2.tar.gz
...
%prep
%setup -q -n griffe-0.42.2
cd %{_builddir}/griffe-0.42.2
pushd ..
cp -a griffe-0.42.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713283449
