...
Version  : 0.42.0
Release  : 42
URL      : https://files.pythonhosted.org/packages/40/6a/69e4075e7f389e73377913f0209239f7e64f2eef03a84c34ea41f5dd7249/griffe-0.42.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/40/6a/69e4075e7f389e73377913f0209239f7e64f2eef03a84c34ea41f5dd7249/griffe-0.42.0.tar.gz
...
%prep
%setup -q -n griffe-0.42.0
cd %{_builddir}/griffe-0.42.0
pushd ..
cp -a griffe-0.42.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710201925
