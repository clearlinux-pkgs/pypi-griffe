...
Version  : 0.42.1
Release  : 43
URL      : https://files.pythonhosted.org/packages/9e/62/c75e2979ec226ed53dbf9c4a5b3ccea6a43d910c867077d5d452d6535371/griffe-0.42.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/9e/62/c75e2979ec226ed53dbf9c4a5b3ccea6a43d910c867077d5d452d6535371/griffe-0.42.1.tar.gz
...
%prep
%setup -q -n griffe-0.42.1
cd %{_builddir}/griffe-0.42.1
pushd ..
cp -a griffe-0.42.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710946743
