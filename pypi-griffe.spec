...
Version  : 0.38.0
Release  : 31
URL      : https://files.pythonhosted.org/packages/4a/bb/7d682462993a9be15e0a34d28336955fbcd6fdfaeca932a66a6ea12ad180/griffe-0.38.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/4a/bb/7d682462993a9be15e0a34d28336955fbcd6fdfaeca932a66a6ea12ad180/griffe-0.38.0.tar.gz
...
%prep
%setup -q -n griffe-0.38.0
cd %{_builddir}/griffe-0.38.0
pushd ..
cp -a griffe-0.38.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699919384
