...
Version  : 0.40.1
Release  : 37
URL      : https://files.pythonhosted.org/packages/70/27/964e5e6a405d1b6171bde91b5bf8613c64d05502ac5dc29ceaccb5661d7f/griffe-0.40.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/70/27/964e5e6a405d1b6171bde91b5bf8613c64d05502ac5dc29ceaccb5661d7f/griffe-0.40.1.tar.gz
...
%prep
%setup -q -n griffe-0.40.1
cd %{_builddir}/griffe-0.40.1
pushd ..
cp -a griffe-0.40.1 buildavx2
popd
pushd ..
cp -a griffe-0.40.1 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707498657
