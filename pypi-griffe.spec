...
Version  : 1.5.5
Release  : 70
URL      : https://files.pythonhosted.org/packages/5c/74/cd35a98cb11f79de0581e8e1e6fbd738aeeed1f2d90e9b5106728b63f5f7/griffe-1.5.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/5c/74/cd35a98cb11f79de0581e8e1e6fbd738aeeed1f2d90e9b5106728b63f5f7/griffe-1.5.5.tar.gz
...
%prep
%setup -q -n griffe-1.5.5
cd %{_builddir}/griffe-1.5.5
pushd ..
cp -a griffe-1.5.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737131861
